...
const res = await fetch("https://miro-store-1.onrender.com/api/cart/update", {
method: "PUT",
headers: {
...
const res = await fetch("https://miro-store-1.onrender.com/api/cart/remove", {
method: "DELETE",
headers: {
"Content-Type": "application/json",
Authorization: `Bearer ${authToken}`,
...
src={`https://miro-store-1.onrender.com${item.image}`}
alt={item.name}
/>
